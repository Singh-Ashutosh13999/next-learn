    ...
    >
      <section
        style={{
          ...
          padding: "80px",
          background: "linear-gradient(135deg, #2563eb, #4b63a5)",
          color: "white",
          flexWrap: "wrap",
        }}
      >
        <div style={{ maxWidth: "550px" }}>
          ...
          <p style={{ fontSize: "18px", lineHeight: "1.8", color: "#e2e8f0" }}>
            ...
            Next.js. Learn routing, layouts, components, APIs, and much more
      ...
      <section style={{ padding: "80px", textAlign: "center" }}>
        <h2 style={{ fontSize: "40px", marginBottom: "15px", color: "#1e293b" }}>
          Why Learn With Us?
        </h2>
